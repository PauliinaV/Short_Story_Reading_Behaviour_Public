...
Whereas linearity of reading and reading speed are analysed with this reader characteristics structure, task-switching is modelled without 'Cond x SComp', 'CMot x SComp', and 'TR-EExp1 x TR-EExp2 x SComp'. This is because linearity and speed are expected to be connected to motivation and electronic experience via interaction with situational competence, whereas task switching is expected to be connected to motivation and electronic experience directly (main effects).
...
```{r 'backward-stepwise-select-slopes'}
...
```{r 'create-preceding-event-variables'}
...
Speed_EP_AdditiveModel_nested1_1 <- lmer( #nc, sing
    AdditiveStructure_EP_nested_slope1_1,
    data = reading_speed_measure_data,
    control = lmerControl(optimizer = "bobyqa"),
    REML = FALSE
...
anova(Speed_EP_AdditiveModel_nested1_2, Speed_EP_AdditiveModel_nested_interceptsonly) # DUD sig contributes, p = .0011
# 3
...
anova(Speed_EP_AdditiveModel_nested1_3, Speed_EP_AdditiveModel_nested_interceptsonly) # sig contributes, p = .0321
# 4
...
anova(Speed_EP_AdditiveModel_nested1_4, Speed_EP_AdditiveModel_nested_interceptsonly) # does not contribute, p > .2
# 5
...
anova(Speed_EP_AdditiveModel_nested1_5, Speed_EP_AdditiveModel_nested_interceptsonly) # sig contributes, p = .0033
# 6
...
anova(Speed_EP_AdditiveModel_nested1_6, Speed_EP_AdditiveModel_nested_interceptsonly) # sig contributes, p < .0001
# 7
...
anova(Speed_EP_AdditiveModel_nested1_7, Speed_EP_AdditiveModel_nested_interceptsonly) # sig contributes, p < .0001
```
...
anova(Speed_EP_AdditiveModel_nested2, Speed_EP_AdditiveModel_nested2_2) # sig contributes, p = .010
## 2_3
...
anova(Speed_EP_AdditiveModel_nested2, Speed_EP_AdditiveModel_nested2_3) # does not contribute, p > .2
## 2_4
...
anova(Speed_EP_AdditiveModel_nested2, Speed_EP_AdditiveModel_nested2_5) # contributes, p = .15
## 2_6
...
anova(Speed_EP_AdditiveModel_nested2, Speed_EP_AdditiveModel_nested2_6) # sig contributes, p = .00142
```

```{r 'test-slopes3'}
# slope test 3
## Start adding all slopes again to the most sig slopes: LOC + TRS
    ## 3_1: WW
    ## 3_2: DUD
    ## 3_3: Event k-1
    ## 3_4: Event k-2
...
AdditiveStructure_EP_nested_slope3_1 <- (
    "ReadingRate ~ WindowWidth.sc + DaysUntilDeadline.sc + Observation_lag1.sc + Observation_lag2.sc + ReadingSessionNumber.sc + TimeInReadingSession.sc + PercentageLocation.sc + (1 + PercentageLocation.sc + TimeInReadingSession.sc + WindowWidth.sc | StoryId / UserId)"
)
...
anova(Speed_EP_AdditiveModel_nested3, Speed_EP_AdditiveModel_nested3_1) # contributes, p = .092
## 3_2
AdditiveStructure_EP_nested_slope3_2 <- (
    "ReadingRate ~ WindowWidth.sc + DaysUntilDeadline.sc + Observation_lag1.sc + Observation_lag2.sc + ReadingSessionNumber.sc + TimeInReadingSession.sc + PercentageLocation.sc + (1 + PercentageLocation.sc + TimeInReadingSession.sc + DaysUntilDeadline.sc | StoryId / UserId)"
)
Speed_EP_AdditiveModel_nested3_2 <- lmer( # sing
    AdditiveStructure_EP_nested_slope3_2,
    data = reading_speed_measure_data,
    control = lmerControl(optimizer = "bobyqa"),
    REML = FALSE
...
AdditiveStructure_EP_nested_slope3_3 <- (
    "ReadingRate ~ WindowWidth.sc + DaysUntilDeadline.sc + Observation_lag1.sc + Observation_lag2.sc + ReadingSessionNumber.sc + TimeInReadingSession.sc + PercentageLocation.sc + (1 + PercentageLocation.sc + TimeInReadingSession.sc + Observation_lag1.sc | StoryId / UserId)"
)
...
AdditiveStructure_EP_nested_slope3_4 <- (
    "ReadingRate ~ WindowWidth.sc + DaysUntilDeadline.sc + Observation_lag1.sc + Observation_lag2.sc + ReadingSessionNumber.sc + TimeInReadingSession.sc + PercentageLocation.sc + (1 + PercentageLocation.sc + TimeInReadingSession.sc + Observation_lag2.sc | StoryId / UserId)"
)
...
AdditiveStructure_EP_nested_slope3_5 <- (
    "ReadingRate ~ WindowWidth.sc + DaysUntilDeadline.sc + Observation_lag1.sc + Observation_lag2.sc + ReadingSessionNumber.sc + TimeInReadingSession.sc + PercentageLocation.sc + (1 + PercentageLocation.sc + TimeInReadingSession.sc + ReadingSessionNumber.sc | StoryId / UserId)"
)
Speed_EP_AdditiveModel_nested3_5 <- lmer( # sing, nc
    AdditiveStructure_EP_nested_slope3_5,
    data = reading_speed_measure_data,
    control = lmerControl(optimizer = "bobyqa"),
    REML = FALSE
)
anova(Speed_EP_AdditiveModel_nested3, Speed_EP_AdditiveModel_nested3_5) # sig contributes, p = .0129
```

```{r}
# slope test 4
## Start adding all slopes again to the most sig slopes: LOC + TRS + RSN
    ## 4_1: WW - same as 1
    ## 4_2: DUD
    ## 4_3: Event k-1
    ## 4_4: Event k-2
...
AdditiveStructure_EP_nested_slope4 <- (
    "ReadingRate ~ WindowWidth.sc + DaysUntilDeadline.sc + Observation_lag1.sc + Observation_lag2.sc + ReadingSessionNumber.sc + TimeInReadingSession.sc + PercentageLocation.sc + (1 + TimeInReadingSession.sc + PercentageLocation.sc + ReadingSessionNumber.sc | StoryId / UserId)"
)
Speed_EP_AdditiveModel_nested4 <- lmer( #sing, nc
    AdditiveStructure_EP_nested_slope4,
    data = reading_speed_measure_data,
    control = lmerControl(optimizer = "bobyqa"),
    REML = FALSE
...
# 4_1 
AdditiveStructure_EP_nested_slope4_1 <- (
    "ReadingRate ~ WindowWidth.sc + DaysUntilDeadline.sc + Observation_lag1.sc + Observation_lag2.sc + ReadingSessionNumber.sc + TimeInReadingSession.sc + PercentageLocation.sc + (1 + PercentageLocation.sc + TimeInReadingSession.sc + ReadingSessionNumber.sc + WindowWidth.sc | StoryId / UserId)"
)
Speed_EP_AdditiveModel_nested4_1 <- lmer( # sing, nc
    AdditiveStructure_EP_nested_slope4_1,
    data = reading_speed_measure_data,
    control = lmerControl(optimizer = "bobyqa"),
    REML = FALSE
)
anova(Speed_EP_AdditiveModel_nested4, Speed_EP_AdditiveModel_nested4_1) # does not contribute, p > .2
# 4_2
AdditiveStructure_EP_nested_slope4_2 <- (
    "ReadingRate ~ WindowWidth.sc + DaysUntilDeadline.sc + Observation_lag1.sc + Observation_lag2.sc + ReadingSessionNumber.sc + TimeInReadingSession.sc + PercentageLocation.sc + (1 + PercentageLocation.sc + TimeInReadingSession.sc + ReadingSessionNumber.sc + DaysUntilDeadline.sc | StoryId / UserId)"
)
Speed_EP_AdditiveModel_nested4_2 <- lmer( # sing, nc
    AdditiveStructure_EP_nested_slope4_2,
    data = reading_speed_measure_data,
    control = lmerControl(optimizer = "bobyqa"),
    REML = FALSE
)
anova(Speed_EP_AdditiveModel_nested4, Speed_EP_AdditiveModel_nested4_2) # does not contribute, p > .2
## 4_3
AdditiveStructure_EP_nested_slope4_3 <- (
    "ReadingRate ~ WindowWidth.sc + DaysUntilDeadline.sc + Observation_lag1.sc + Observation_lag2.sc + ReadingSessionNumber.sc + TimeInReadingSession.sc + PercentageLocation.sc + (1 + PercentageLocation.sc + TimeInReadingSession.sc + ReadingSessionNumber.sc + Observation_lag1.sc | StoryId / UserId)"
)
Speed_EP_AdditiveModel_nested4_3 <- lmer( # sing, nc
    AdditiveStructure_EP_nested_slope4_3,
    data = reading_speed_measure_data,
    control = lmerControl(optimizer = "bobyqa"),
    REML = FALSE
)
anova(Speed_EP_AdditiveModel_nested4, Speed_EP_AdditiveModel_nested4_3) # does not contribute, p > .2
## 4_4
AdditiveStructure_EP_nested_slope4_4 <- (
    "ReadingRate ~ WindowWidth.sc + DaysUntilDeadline.sc + Observation_lag1.sc + Observation_lag2.sc + ReadingSessionNumber.sc + TimeInReadingSession.sc + PercentageLocation.sc + (1 + PercentageLocation.sc + TimeInReadingSession.sc + ReadingSessionNumber.sc + Observation_lag2.sc | StoryId / UserId)"
)
Speed_EP_AdditiveModel_nested4_4 <- lmer( # sing, nc
    AdditiveStructure_EP_nested_slope4_4,
    data = reading_speed_measure_data,
    control = lmerControl(optimizer = "bobyqa"),
    REML = FALSE
)
anova(Speed_EP_AdditiveModel_nested4, Speed_EP_AdditiveModel_nested4_4) # does not contribute, p > .2
```

None of the new slopes significantly add to the model, and so our final additive model includes random slopes for location in text, reading session number, and time in a reading session.
Refit the additive model with REML:

```{r 'refit-additive-model-with-REML'}
...
The additive model with random slopes is nonconvergent and singular. To address this, we simplify the model backward stepwise until convergence.
...
```{r 'ep-backward-stepwise-selection-slopes'}
...
AdditiveStructure_EP_nested_slope5_1 <- (
    "ReadingRate ~ WindowWidth.sc + DaysUntilDeadline.sc + Observation_lag1.sc + Observation_lag2.sc + ReadingSessionNumber.sc + TimeInReadingSession.sc + PercentageLocation.sc + (1 + TimeInReadingSession.sc + ReadingSessionNumber.sc | StoryId / UserId)"
)
AdditiveStructure_EP_nested_slope5_1 <- lmer( #remains nc and sing
    AdditiveStructure_EP_nested_slope5_1,
    data = reading_speed_measure_data,
    control = lmerControl(optimizer = "bobyqa")
)
summary(AdditiveStructure_EP_nested_slope5_1) # Time in reading session accounts for the least variance
# Remove TRS
AdditiveStructure_EP_nested_slope5_2 <- (
    "ReadingRate ~ WindowWidth.sc + DaysUntilDeadline.sc + Observation_lag1.sc + Observation_lag2.sc + ReadingSessionNumber.sc + TimeInReadingSession.sc + PercentageLocation.sc + (1 + ReadingSessionNumber.sc | StoryId / UserId)"
)
AdditiveStructure_EP_nested_slope5_2 <- lmer( #converges and is no longer singular
    AdditiveStructure_EP_nested_slope5_2,
    data = reading_speed_measure_data,
    control = lmerControl(optimizer = "bobyqa")
)
...
The additive model converges after removal of the random slopes Location and Time in a reading session.
The final additive model includes a random slope of reading session number only.
Inspect model values:

```{r}
summary(AdditiveStructure_EP_nested_slope5_2)
plot(AdditiveStructure_EP_nested_slope5_2)
fixef(AdditiveStructure_EP_nested_slope5_2)
```
...
InteractiveStructure_EP_nested_slopes <- (
    "ReadingRate ~ WindowWidth.sc + DaysUntilDeadline.sc + Observation_lag1.sc + Observation_lag2.sc + ReadingSessionNumber.sc + TimeInReadingSession.sc + PercentageLocation.sc + Observation_lag1.sc : Observation_lag2.sc + ReadingSessionNumber.sc : TimeInReadingSession.sc + ReadingSessionNumber.sc : PercentageLocation.sc + TimeInReadingSession.sc : PercentageLocation.sc + (1 + ReadingSessionNumber.sc | StoryId / UserId)"
)
```
...
(3) Significant interaction effect between Event~k-1~ and Event~k-2~
(4) Significant interaction effect between ReadingSessionNumber and PercentageLocation

We first inspect the main effect of Observation_lag1 (1) and interaction between Observation_lag1 and Observation_lag2 (3), and then the remaining significant effects (2, and 4).
...
```{r}
speed_ep_previouslag12 <- interact_plot(
    Speed_EP_InteractiveModel_nested_slopes,
    pred = Observation_lag1.sc,
    modx = Observation_lag2.sc,
    plot.points = TRUE,
    legend.main = addline_format("Event~k-2~"),
    point.alpha = .2,
    interval = TRUE
) +
    figure_theme_with_top_legend +
...
The significant interaction effect shows that the positive relationship between the outcome variable and Event~k-1~ is stronger if Event~k-2~ included a slow reading rate. In contrast, there is only a weak relationship between Event~k-1~ and the outcome variable if Event~k-2~ included a fast reading rate.
This indicates that it is more difficult to predict changes in reading rate following a fast rather a slower speed. It could be because faster reading speeds are used for a variety of different purposes - but this is just one possibility.

#### Impact of reading session number and location in text
...
This main effect was qualified by a significant interaction between PercentageLocation and ReadingSessionNumber.
...
A statistically significant difference is seen between different reading sessions: Early reading sessions are connected to a stronger positive association between reading speed and location in text, compared to latter reading sessions. Therefore, participants who read most of the text in early reading sessions may have increased their reading speed towards the end of the text. In contrast, participants who divided their reading in multiple reading sessions, varied their speed less across the text.
