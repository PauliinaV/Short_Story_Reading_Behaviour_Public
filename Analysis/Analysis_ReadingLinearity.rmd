...
```{r 'add-contrasts-to-storyid', include=FALSE}
...
```{r 'select-slopes1', eval=FALSE, echo=FALSE}
# slope test 1
    ## 1_1 WW
    ## 1_2 DUD
    ## 1_3 Event k-1
...
```{r 'select-slopes2', eval=FALSE, echo=FALSE}
# slope test 2
...
```{r 'additive-model-with-slopes', eval=FALSE}
...
```{r 'select-slopes-adjusted1', eval=FALSE, echo=FALSE}
