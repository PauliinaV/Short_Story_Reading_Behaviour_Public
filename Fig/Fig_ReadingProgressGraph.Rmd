...
grouped_navigation_blocks_data$NBFirstPercentage <- (
    grouped_navigation_blocks_data$NBFirstStartLocation
        / grouped_navigation_blocks_data$ChLength
)
...
graph_subset_data <- graph_subset_data %>%
    # Rename Conditions
    mutate(
        Condition = recode(
            Condition,
...
ChronologicalAblineStoryId1 <- data.frame(
    ...
    "slope" = (100 / ((unique(StoryId1$ChLength) / 5) / 250)),
    "label" = "Chronological"
)
```
...
ChronologicalAblineStoryId2 <- data.frame(
    "intercept" = 0,
    # slope value is (100/((character length/5)/population average speed))
    "slope" = (100 / ((unique(StoryId2$ChLength) / 5) / 250)),
    "label" = "Chronological"
)
```
...
ChronologicalAblineStoryId3 <- data.frame(
    "intercept" = 0,
    # slope value is (100/((character length/5)/population average speed))
    "slope" = (100 / ((unique(StoryId3$ChLength) / 5) / 250)),
    "label" = "Chronological"
)
```
...
ChronologicalAblineStoryId4 <- data.frame(
    "intercept" = 0,
    # slope value is (100/((character length/5)/population average speed))
    "slope" = (100 / ((unique(StoryId4$ChLength) / 5) / 250)),
    "label" = "Chronological"
)
```
...
ChronologicalAblineStoryId5 <- data.frame(
    "intercept" = 0,
    # slope value is (100/((character length/5)/population average speed))
    "slope" = (100 / ((unique(StoryId5$ChLength) / 5) / 250)),
    "label" = "Chronological"
)
```
...
ChronologicalAblineStoryId6 <- data.frame(
    "intercept" = 0,
    # slope value is (100/((character length/5)/population average speed))
    "slope" = (100 / ((unique(StoryId6$ChLength) / 5) / 250)),
    "label" = "Chronological"
)
```
...
ChronologicalAblineStoryId7 <- data.frame(
    "intercept" = 0,
    # slope value is (100/((character length/5)/population average speed))
    "slope" = (100 / ((unique(StoryId7$ChLength) / 5) / 250)),
    "label" = "Chronological"
)
```
...
ChronologicalAblineStoryId8 <- data.frame(
    "intercept" = 0,
    # slope value is (100/((character length/5)/population average speed))
    "slope" = (100 / ((unique(StoryId8$ChLength) / 5) / 250)),
    "label" = "Chronological"
)
```
...
ChronologicalAblineStoryId9 <- data.frame(
    "intercept" = 0,
    # slope value is (100/((character length/5)/population average speed))
    "slope" = (100 / ((unique(StoryId9$ChLength) / 5) / 250)),
    "label" = "Chronological"
)
```
