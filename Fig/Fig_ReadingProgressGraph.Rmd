...
```{r 'flip coordinates and print graph2', warning=FALSE}
Graph2d <- Graph2c +
    coord_flip(
        ylim = c(0, 100),
        xlim = c(0, 130)
...
ChronologicalAblineStoryId1 <- data.frame(
    ...
    "slope" = (100 / ((unique(StoryId1$CharacterLength) / 5) / 250)),
    "label" = "Chronological"
)
```
...
ChronologicalAblineStoryId2 <- data.frame(
    "intercept" = 0,
    # slope value is (100/((character length/5)/population average speed))
    "slope" = (100 / ((unique(StoryId2$CharacterLength) / 5) / 250)),
    "label" = "Chronological"
)
```
...
ChronologicalAblineStoryId3 <- data.frame(
    "intercept" = 0,
    # slope value is (100/((character length/5)/population average speed))
    "slope" = (100 / ((unique(StoryId3$CharacterLength) / 5) / 250)),
    "label" = "Chronological"
)
```
...
ChronologicalAblineStoryId4 <- data.frame(
    "intercept" = 0,
    # slope value is (100/((character length/5)/population average speed))
    "slope" = (100 / ((unique(StoryId4$CharacterLength) / 5) / 250)),
    "label" = "Chronological"
)
```
...
ChronologicalAblineStoryId5 <- data.frame(
    "intercept" = 0,
    # slope value is (100/((character length/5)/population average speed))
    "slope" = (100 / ((unique(StoryId5$CharacterLength) / 5) / 250)),
    "label" = "Chronological"
)
```
...
ChronologicalAblineStoryId6 <- data.frame(
    "intercept" = 0,
    # slope value is (100/((character length/5)/population average speed))
    "slope" = (100 / ((unique(StoryId6$CharacterLength) / 5) / 250)),
    "label" = "Chronological"
)
```
...
ChronologicalAblineStoryId7 <- data.frame(
    "intercept" = 0,
    # slope value is (100/((character length/5)/population average speed))
    "slope" = (100 / ((unique(StoryId7$CharacterLength) / 5) / 250)),
    "label" = "Chronological"
)
```
...
ChronologicalAblineStoryId8 <- data.frame(
    "intercept" = 0,
    # slope value is (100/((character length/5)/population average speed))
    "slope" = (100 / ((unique(StoryId8$CharacterLength) / 5) / 250)),
    "label" = "Chronological"
)
```
...
ChronologicalAblineStoryId9 <- data.frame(
    "intercept" = 0,
    # slope value is (100/((character length/5)/population average speed))
    "slope" = (100 / ((unique(StoryId9$CharacterLength) / 5) / 250)),
    "label" = "Chronological"
)
```
...
## 3. Progress graphs for two stories with most participants
...
StoryId 1 has 11 participants and StoryId 2 has 10 participants, and so we use these two stories.

```{r}
Graph31e_grid <- Graph31e + figure_theme_without_legend
Graph32e_grid <- Graph32e + figure_theme_without_legend
GridArrangedPlot <- grid.arrange(Graph31e_grid, Graph32e_grid, nrow = 1)
```

```{r, eval=FALSE}
ggsave(
    "Fig_ProgressGraphTwoStory.png",
    plot = GridArrangedPlot,
    width = 5,
    height = 6,
    units = "in",
    dpi = 300
