...
First, we create a dataset with only the responses to IMI:
...
for (item in 2:length(TaskIMI)) {
  if (any((colnames(TaskIMI)[item]) == ReversedItemsIMI)) {
    TaskIMI[, item] = 8 - TaskIMI[, item]
  }
}
