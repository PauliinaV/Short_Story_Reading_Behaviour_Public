...
The above code shows that `r sum(raw_tracking_data$DurationMinutes != raw_tracking_data$AdjustedEventDuration)` event durations were adjusted.
...
artefacts_removed_tracking_data$Percentage <- (
    artefacts_removed_tracking_data$StartLocation / artefacts_removed_tracking_data$ChLength
)
```
