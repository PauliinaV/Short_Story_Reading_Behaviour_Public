...
The purpose of this script is to compute a measure of reading linearity. Linearity refers to the frequency of nonlinear navigation during reading of the short story. This script uses a dataframe that was wrangled in Prep_TrackingDataWrangling.Rmd.
...
In order to calculate a measure of reading linearity, it is necessary to determine whether each navigation event in the data refers to nonlinear or linear navigation. Linear navigation was defined as movement forwards in the text without skipping any pages, whereas nonlinear navigation was defined as a regression or a forward leap according to the following:
