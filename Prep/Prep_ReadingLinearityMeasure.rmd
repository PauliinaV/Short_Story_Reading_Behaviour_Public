...
## Find event that initiates nonlinearity
for (row in 1:nrow(wrangled_tracking_data)) {
    if(row == 1 |
        ...
        if(wrangled_tracking_data[row, "IsNonlinearNavigation"]) {
            wrangled_tracking_data[row, "InitiatesNonlinearity"] <-
                TRUE
        } else {
            wrangled_tracking_data[row, "InitiatesNonlinearity"] <-
                FALSE
        ...
        if ((wrangled_tracking_data[row - 1, "Linearity"] !=
                ...
                wrangled_tracking_data[row, "IsNonlinearNavigation"]) {
                    # previous event linearity != current event linearity
                    ## and current event is nonlinear
                    wrangled_tracking_data[row, "InitiatesNonlinearity"] <- TRUE
                } else {
                    wrangled_tracking_data[row, "InitiatesNonlinearity"] <-
                    FALSE
                }
